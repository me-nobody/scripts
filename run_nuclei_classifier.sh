...
#SBATCH --job-name=nuclei_classifier   # some descriptive job name of your choice
...
python3 /users/ad394h/Documents/nuclei_segment/scripts/train_nuclei_classifier.py
echo "over with job"
